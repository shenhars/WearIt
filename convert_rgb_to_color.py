class ColorNames:
    ...
    def findNearestWebColorName(R, G, B):
        return ColorNames.findNearestColorName(R, G, B,
                                               ColorNames.WebColorMap)

    @staticmethod
    def findNearestImageMagickColorName(R, G, B):
        return ColorNames.findNearestColorName(R, G, B,
                                               ColorNames.ImageMagickColorMap)
...
if __name__ == "__main__":
    R,G,B = 243, 150, 3
    print(ColorNames.findNearestWebColorName(R, G, B))
    # print(ColorNames.findNearestImageMagickColorName(0, 150, 0))